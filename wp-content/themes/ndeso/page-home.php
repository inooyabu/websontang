...
get_header(); ?>
    ...
    <div class="ndeleft clear">
	    <h3 class="homti"><?php echo (get_option('gtpengumuman')) ? get_option('gtpengumuman') : 'PENGUMUMAN DARI DESA' ?></h3>
	    <div class="homhalf">
			<?php query_posts('post_type=pengumuman&showposts=6'); ?>
							...
							<div class="homloop">
						    	...
						    	<div class="slide-info">
									...
									<a href="<?php the_permalink() ?>" class="thumb">
								    	<img src="<?php echo get_template_directory_uri(); ?>/images/pengumuman.png"/>
									</a>
									<?php } ?>
							    	<div class="meta-info">
				    ...
				    <div class="homloop">
			    		<div class="slide-info">
					    	...
					    	<div class="meta-info">
								    	...
								    	<h3><a href="#">Belum ada Pengumuman</a></h3>
							        	Buat sebuah Pengumuman terlebih dahulu<br/>
										Dashboard > Pengumuman > Tambah Pengumuman<br/><br/>
							</div>
						</div>
					</div>
				</div>
				<div class="halfleft">
				    		<div class="slide-inforight">
								...
								<span>SENIN, 29 Mei 2017</span>
								<h3><a href="#">Contoh Post Pengumuman</a></h3>
							</div>
							<div class="slide-inforight">
						    	<a href="#" class="thumb">
				    	    		<img src="<?php echo get_template_directory_uri(); ?>/images/pengumuman.png"/>
    ...
    <div class="ndeleft clear">
		...
		<div class="halfleft">
		<h3 class="homti"><?php echo (get_option('gtopwarga')) ? get_option('gtopwarga') : 'OPINI WARGA DESA' ?></h3>
				    ...
				    <?php if (have_posts()) { ?>
					    <?php while (have_posts()): the_post(); ?>
				    		<div class="slide-inforight">
								...
								<span class="grey">
						        		<?php
										printf(__('penulis : %s, pada %s', 'ndeso'),
										get_the_author(),
										get_the_time('l, j M Y')
										); ?>
								</span>
    ...
    <div class="ndeleft clear">
	    <h3 class="homti"><?php echo (get_option('gtprodes')) ? get_option('gtprodes') : 'PRODUK KOMODITAS DESA' ?></h3>
	    <div class="homhalf">
			<?php query_posts('post_type=produk-desa&showposts=6'); ?>
