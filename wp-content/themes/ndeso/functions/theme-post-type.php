...
/*** POST TYPE OPINI ***/		
	...
	register_post_type( 'opini',		
	array(			
	    'labels' => array(				
	    'name' => __( 'Opini Warga' ),				
	    'singular_name' => __( 'Opini Warga' ),        
	    'add_new' => __( 'Tambah Opini?' ),	
	    'add_new_item' => __( 'Tambah Opini' ),	
	    'edit' => __( 'Edit' ),	 
	    'edit_item' => __( 'Edit Opini' ),	
	    'new_item' => __( 'Opini Baru' ),	
	    'view' => __( 'Lihat Opini' ),	
	    'view_item' => __( 'Lihat Opini' ),	
	    'search_items' => __( 'Cari Opini' ),	
	    'not_found' => __( 'Tidak ada Opini ditemukan' ),	
	    'not_found_in_trash' => __( 'Tidak ada Opini di folder Trash' ),	
	    'parent' => __( 'Parent Super Duper' ),			
	    ),		                	
		'public' => true,           					            
		'has_archive' => true,        			            
